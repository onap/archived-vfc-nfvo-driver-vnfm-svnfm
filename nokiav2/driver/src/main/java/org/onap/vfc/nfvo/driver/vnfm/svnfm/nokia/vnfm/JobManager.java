...
import org.onap.vfc.nfvo.driver.vnfm.svnfm.nokia.onap.vfc.VfcLifecycleChangeNotificationManager;
...
import static org.onap.vfc.nfvo.driver.vnfm.svnfm.nokia.api.ILifecycleChangeNotificationManager.SEPARATOR;
    ...
    public String spawnJob(String vnfId, HttpServletResponse response) {
        ...
        synchronized (this) {
            if (!selfRegistrationManager.isReady()) {
                ...
                throw new RuntimeException("The service is not yet ready");
            }
