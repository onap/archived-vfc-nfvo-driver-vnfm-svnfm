...
import org.onap.vnfmadapter.so.v2.model.SoV2VnfCreateRequest;
import org.onap.vnfmadapter.so.v2.model.SoV2VnfCreateResponse;
import org.onap.vnfmadapter.so.v2.model.SoV2VnfDeleteRequest;
...
public class SoV2Api {
     ...
     */
    @RequestMapping(value = "/vnfs/{vnfIdInAai}", method = POST, produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
    @ResponseBody
    public SoV2VnfCreateResponse createVnf(@RequestBody SoV2VnfCreateRequest request, @PathVariable("vnfIdInAai") String vnfIdInAai, HttpServletResponse httpResponse) {
        logger.info("REST: Create the VNF");
        SoV2VnfCreateResponse response = soLifecycleManager.createVnf(vnfIdInAai, request, httpResponse);
