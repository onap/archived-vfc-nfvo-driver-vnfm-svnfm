...
public class TestLifecycleManager extends TestBase {
    ...
    public void initMocks() throws Exception {
        ...
        modifyPropertyoperationExecution.setStartTime(DateTime.now());
    ...
    public void testInstantiation() throws Exception {
        ...
        assertEquals(Boolean.valueOf(parseBoolean(vimInfo.getSslInsecure())), actualVim.getInterfaceInfo().getSkipCertificateVerification());
        ...
        assertEquals(Boolean.TRUE, actualInstantiationRequest.getValue().getGrantlessMode());
        ...
        assertTrue(actualVim.getInterfaceInfo().getSkipCertificateVerification());
        assertTrue(actualVim.getInterfaceInfo().getSkipCertificateHostnameCheck());
    ...
    public void testQuery() throws Exception {
        ...
        //FIXME ? (do not know what exactly the vnf version mean in onap terminology)
