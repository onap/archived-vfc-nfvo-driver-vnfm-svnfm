...
import static org.onap.vfc.nfvo.driver.vnfm.svnfm.nokia.vfc.VfcRestApiProvider.*;
...
public class TestVfcRestApiProvider extends TestBase {
    ...
    public void testNsLcmApi() throws Exception {
        when(msbApiProvider.getMicroServiceUrl(NSLCM_API_SERVICE_NAME, NSLCM_API_VERION)).thenReturn("http://1.2.3.4:1234/nslcm/v1/lead");
        //when
    ...
    public void testNsCatalogApi() throws Exception {
        when(msbApiProvider.getMicroServiceUrl(NSCATALOG_SERVICE_NAME, NSCATALOG_API_VERSION)).thenReturn("http://1.2.3.4:1234/lead");
        //when
